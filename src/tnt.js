...
(function () {
  ...
  if (!meta.tnt_side) meta.tnt_side = { x: 32, y: 48, w: 16, h: 16, src: 'generated:tnt.js' }; // free atlas cell
  if (!meta.tnt_top) meta.tnt_top = { x: 48, y: 48, w: 16, h: 16, src: 'generated:tnt.js' };
