...
if (!name) { console.error('usage: node tools/shot.mjs <scenario>  (registered in src/harness.js CF.shotScenarios)'); process.exit(2); }
...
runBrowser({ url: toFileUrl(p('game', 'index.html')) + `#shot=${name}`, screenshot: out, budget: 9000, timeout: 90000 });
